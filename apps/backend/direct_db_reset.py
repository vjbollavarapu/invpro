...
This script bypasses Django and directly resets the database,
then creates a simple migration application script.
"""
...
def reset_database():
    """Reset the database directly"""
    print("🔄 Resetting database directly...")
...
def create_simple_migration_script():
    """Create a simple script to apply migrations without Django commands"""
...
'''
    ...
    with open('apply_migrations.py', 'w') as f:
        f.write(script_content)
    
    os.chmod('apply_migrations.py', 0o755)
    print("✅ Created apply_migrations.py script")

def main():
    """Main function"""
    print("🔄 Starting direct database reset...")
    ...
    print("🎉 You can now run './apply_migrations.py' to apply the new structure!")
